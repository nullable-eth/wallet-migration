...
func main() {
	...
	balanceEmptyingTransactions := transferBalances(client, common.HexToAddress(in.DestinationAddress), gasPrice, updatedAccounts, make([]RPC.TransactionWithOriginator, 0))
...
func transferBalances(client RPC.Client, destinationAddress common.Address, gasPrice *big.Int, accounts []Accounts.Account, transactions []RPC.TransactionWithOriginator) []RPC.TransactionWithOriginator {
