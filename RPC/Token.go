...
type TokenSession struct {
	...
	TransactOpts bind.TransactOpts // SignedTx auth options to use throughout this session
}
...
func (_Token *TokenCaller) Allowance(opts *bind.CallOpts, tokenOwner common.Address, spender common.Address) (*big.Int, error) {
	...
	out := ret0
	err := _Token.contract.Call(opts, &[]interface{}{ out }, "allowance", tokenOwner, spender)
	return *ret0, err
}
...
func (_Token *TokenCaller) BalanceOf(opts *bind.CallOpts, tokenOwner common.Address) (*big.Int, error) {
	...
	err := _Token.contract.Call(opts, output, "balanceOf", tokenOwner)
	return *ret0, err
}
...
func (_Token *TokenCaller) Decimals(opts *bind.CallOpts) (uint8, error) {
	...
	out := ret0
	output := &[]interface{}{ out }
	err := _Token.contract.Call(opts, output, "decimals")
	return *ret0, err
}
...
func (_Token *TokenCaller) Symbol(opts *bind.CallOpts) (string, error) {
	...
	out := ret0
	output := &[]interface{}{ out }
	err := _Token.contract.Call(opts, output, "symbol")
	return *ret0, err
}
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				_event := new(TokenApproval)
				if err := _Token.contract.UnpackLog(_event, "Approval", log); err != nil {
					return err
				}
				_event.Raw = log
...
func (_Token *TokenFilterer) WatchTransfer(opts *bind.WatchOpts, sink chan<- *TokenTransfer, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				_event := new(TokenTransfer)
				if err := _Token.contract.UnpackLog(_event, "Transfer", log); err != nil {
					return err
				}
				_event.Raw = log
